...
{
    public class RgbCrossfadeRgbwNode : Node
    {
        public RgbCrossfadeRgbwNode() : base("RGB", "Crossfade RGBW")
        {
            AddInput("Crossfade", DataType.Number);
            AddInput("A", DataType.Text);
            AddInput("B", DataType.Text);
            AddOutput("RGBW", DataType.Text);
        ...
        {
            return "This node makes the crossfade between two RGBW colors. <br/>" +
