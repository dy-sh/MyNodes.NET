...
namespace MyNetSensors.Nodes
{
    public class OperationFlipflopNode : Node
    {
        ...
        public override void OnInputChange(Input input)
        {
            ...
            if (Inputs[0].Value == "1" || Inputs[0].Value == "0")
            {
                switch (part)
                {
                    case 0:
                        if (Inputs[0].Value == "1") result = "1";
                        part++;
                        break;

                    case 1:
                        if (Inputs[0].Value == "0") result = "1";
                        part++;
                        break;

                    case 2:
                        if (Inputs[0].Value == "1") result = "0";
                        part++;
                        break;

                    case 3:
                        if (Inputs[0].Value == "0") result = "0";
                        part = 0;
                        break;
                }
            ...
            LogInfo($"Operation/Flip-Flop: [{Inputs[0].Value}] Flip-Flop to NULL");
