...
namespace ScreenColorTransmitterSignalR
{
    class Program
    {
            ...
            private static SoftNodeSignalRTransmitter transmitter;
            ...
            static void Main(string[] args)
            {
                ...
                transmitter = new SoftNodeSignalRTransmitter(serverAddress, receiverChannel, receiverPassword);
            ...
            private static void CalculateMessagesPerSec()
            {
                ...
                if (messagesPerSecond > 1)
                    ...
                    LogCapture("                               Sent " + messagesPerSecond.ToString("0.00") +
                               " messages/second");
